...
export default function TrackingDashboard() {
        ...
        (async () => {
            ...
            if (Platform.OS === "android") {
                try {
                    ...
                    setDeviceId(id || "UNKNOWN-ANDROID");
                } catch {
                    setDeviceId("UNKNOWN-ANDROID");
                }
            } else {
    ...
    useEffect(() => {
        if (isOnline && apiEndpoint) syncService.startAutoSync(apiEndpoint, 30000);
    ...
    const manualSync = async () => {
        ...
        if (res.success) {
            ...
            Alert.alert("Error", String((res as any).error ?? "No se pudo sincronizar"));
        }
    };
...
const styles = StyleSheet.create({
    ...
    timer: { fontSize: 40, fontWeight: "bold", color: "#111827" },
    muted: { color: "#6b7280" },
